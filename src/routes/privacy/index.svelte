...
<article class="privacy privacy-policy content-wrapper">
  ...
  <section id="section--privacy-policy">
    <div class="main-content">
      ...
      <p>We use your data to provide and improve the Service. By using the Service, you agree to the collection and use of information in accordance with this policy. Unless otherwise defined in this Privacy Policy, the terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, accessible from {$page.host}</p>
...
#section--privacy-policy .grouped {
  margin: 3em 0;
}
</style>